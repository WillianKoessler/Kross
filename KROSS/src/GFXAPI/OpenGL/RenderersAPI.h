...
namespace Kross::OpenGL {
	...
	public:
		...
		virtual void DrawIndexed(const Ref<VertexArray>& va, uint32_t indexCount = 0) const override;
		virtual void DrawIndexed(const Scope<VertexArray>& va, uint32_t indexCount = 0) const override;
